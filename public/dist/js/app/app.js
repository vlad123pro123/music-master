...
window.onload = function () {
  (function () {
        ...
        var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                e.preventDefault();
                genre = button.value; // Установить класс активности на выбранной кнопке жанра
    ...
    showMoreBtn.addEventListener('click', /*#__PURE__*/function () {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              e.preventDefault();
              showMore = true;
              genre = ((_document$querySelect = document.querySelector('.catalog__genres-button.active')) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.value) || 'all'; // Отправить запрос на сервер с параметрами "Показать ещё" и жанром
              _context2.next = 5;
              return fetchData({
                showMore: showMore,
                genre: genre
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmusic_master"] = self["webpackChunkmusic_master"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["dist/css/app/app"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["dist/css/app/app"], () => (__webpack_require__("./resources/scss/app.scss")))
