...
return [
    ...
    'custom' => [
        'file' => [
            'mimes' => 'Ошибка загрузки. Загрузите файл в формате: :values',
            'max' => 'Ошибка. Слишком большой размер файла. Размер файла должен быть не более :max Кб',
            'uploaded' => 'Ошибка. Слишком большой размер файла',
        ],
    ],
    'no_brand' => 'Нет бренда',
    'no_gmail' => 'Нельзя использовать почту из сервисов Gmail, только Яндекс Почта, Mail.ru, Rambler.ru допускаются'
];
